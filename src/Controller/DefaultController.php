...
namespace Drupal\e_schools\Controller;
...
class DefaultController extends ControllerBase {
  ...
  public function google()
  {
    // return ['#markup' => '<iframe src="https://google.com" title="W3Schools Free Online Web Tutorials"></iframe>'];
      ...
      return [
        ...
        '#template' => '<iframe width="600" height="700" src="https://www.yandex.com/embed/RyLwophXGFI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',];
  }
  ...
  public function dashboard($var = null)
  {
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-info">
        ...
        <a href="http://localhost/e-schools/registration" class="small-box-footer">Click to Register <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-6">
  ...
  ',
  '#attached' => [ 'library' => ['e_schools/adminlte3', ]],
];
  }
public function form($var = null)
{
  return [
    '#markup' => ' <div class="direct-chat-contacts">
